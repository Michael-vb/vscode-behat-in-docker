...
export class DockerBehatTestController {
    ...
    constructor(outputChannel: vscode.OutputChannel) {
        ...
        this.outputChannel.appendLine('Initializing DockerBehatTestController');
        
        this.testController = vscode.tests.createTestController('behatDocker', 'Behat in Docker');
    ...
    private setupFileWatcher() {
        ...
        const testFilePattern = config.get<string>('testFilePattern') || '**/*.feature';
