...
suite('DockerBehatTestController Test Suite', () => {
    let testController: DockerBehatTestController;
    ...
    setup(() => {
        ...
        mockWorkspaceConfiguration.get.withArgs('testFilePattern').returns('**/*.feature');
        ...
        // Instantiate the DockerBehatTestController. The constructor will create testDiscovery and testRunner.
        testController = new DockerBehatTestController(mockOutputChannel as any);
    ...
    test('Constructor should initialize correctly', () => {
        ...
        sinon.assert.calledWith(mockOutputChannel.appendLine, 'Initializing DockerBehatTestController');
